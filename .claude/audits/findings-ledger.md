...
| S-H1 | HIGH | 🟢 v3.6.0 VERIFIED CORRECT | Two formulas are **intentionally** different. Strut-fit search deducts plates (part of strut assembly); cut-length deducts wedge (wood replaces strut+plates). Plate heights are correctly excluded from wood cut dimension. **Not a bug** — original audit framing was misleading. | `app.js:125, 3342` | No change. Doctrine confirmed per Paratech O&M; rationale logged in CLAUDE.md v3.6.0 section. |

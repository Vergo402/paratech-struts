---
name: type-v-sim
description: "Run the FEMA Level V structural collapse simulation — car into residential building. Stress-tests FieldShore at minimal operational scale: 1 engine, 3 shore points, single OP period. Use this skill whenever Alex says 'run level v simulation', 'level 5 sim', 'verplanck sim', 'run type v simulation', 'type 5 sim', or '/type-v-sim'."
---
...
Generated by FieldShore simulation skill type-v-sim
EOF
)"
```
...
- **Runtime output:** Write hotwash artifacts to `.claude/simulations/type-v-sim/runtime/`.
- **Prior simulation:** This is the smallest of 5 escalating simulations. See also: `/type-iv-sim`, `/type-iii-sim`, `/type-ii-sim`, `/type-i-sim`.

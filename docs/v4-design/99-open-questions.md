...
| 18 | Demo mode / demo department: scope, behavior, data seeding, and how it appears to first time visitors. | B or E | Added per Alex's feedback at Phase A gate. Bucket 1 (v3.20.0) ships basic demo mode for testing and product marketing. |

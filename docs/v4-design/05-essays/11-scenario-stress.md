...
17. The Phase H vertical slice (per the keen-whistling-pancake plan) is the "Start operation → Add shore point → Deploy strut" workflow. This essay's correction: the slice must be driven through both Verplanck single-engine scale AND Hamden T-Shore-group-of-3 scale before the gate passes. The Verplanck drive proves Principle 11 (quietly earns its place); the Hamden drive proves the grouped-shore wood-choice picker semantic and the multi-apparatus inventory deployment work together.

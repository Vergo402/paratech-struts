...
| **v3.21.0** + **v3.21.2** ([#119](https://github.com/Vergo402/paratech-struts/issues/119)) | Fractional measurement **display** — render measurements as legible fraction glyphs | ✅ | [ADR-012](../11-decisions/ADR-012-measurement-precision-eighth-inch.md) + [`10-quick-find.md`](../08-information-architecture/10-quick-find.md) + [`typography.md`](../07-design-system/typography.md) | v4 upgrades to 1/8″ floored **digit-pair** fractions (drops the super/subscript hack). Field semantics identical. See §2 for the compute half. |

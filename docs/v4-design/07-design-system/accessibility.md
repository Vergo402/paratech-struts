...
**Registry rule.** Each primitive doc still to be filled — `list`, `slider`, `toast` — adds its own script *following this grammar* and links back here. (`sheet` (#183), `modal` (#184), `badge` (#186), `button` (#187), `input` (#189), `toggle` (#190), `segmented` (#191), `empty-state` (#194), `loading-state` (#195), and `nested-checklist` (#196) are filled — their scripts are in the table above.) This file is where the scripts are collected, not where their interaction models are invented.

...
> **Resolution status (2026-06-19, register hygiene).** Most of this list has since shipped — the original bullets are left intact as the point-in-time gate record. **Resolved:** #1 Quick Find (#320) · #2 Command (SitStat) tab built (#323 closed; roll-up #353) · #3 End-Op archive (#339) · #4 extension/plate decrement (#330) · #5 unrated-ack follows the deployed card (`0916f07`) · #6 focus after Deploy (#350) · #7 measurement keypad (S10 / #314) · #8 plate photo thumbnails (#348) · #10 deduction-ledger collapse (#349) · #13 Strut Set → Cutting + full lifecycle (#222/#224/#339) · #9 Power Select fallback (#372, 2026-07-01 — toggle-driven native `<select>` across all picker variants) · #12 picker back-button (#371) · #14 cloud sync (#369). **Still open:** none of the original register. (#11 was already struck inline below.)

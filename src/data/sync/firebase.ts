...
// ONLY v4 Firebase importers (invariant 1; lint bans Firebase in core/ui/app,
// and we hold the line in data/* by routing every RTDB caller through this
// module). Reuses the already-initialized
